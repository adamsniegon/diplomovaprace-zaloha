import * as dataFetchTypes from "./types";
import axios from 'axios';
import {normalize, schema} from "normalizr";

export const dataFetchStart = () => {
    return {
        type: dataFetchTypes.DATA_FETCH_START
    }
}

export const dataFetchSuccess = (cities, places, citiesIds, placesIds) => {
    return {
        type: dataFetchTypes.DATA_FETCH_SUCCESS,
        payload: {
            cities,
            places,
            citiesIds,
...
export const dataFetchError = (error) => {
    return {
        type: dataFetchTypes.DATA_FETCH_ERROR,
        payload: error
    }
}
...
export const dataFetchRefresh = () => {
    return {
        type: dataFetchTypes.DATA_FETCH_REFRESH
    }
}
