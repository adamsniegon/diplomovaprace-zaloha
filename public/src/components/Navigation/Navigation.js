...
function Navigation() {
    ...
    return (
        <nav className="navigation">
            <li className="navigation__list">
                <NavLink className="navigation__link" activeClassName="navigation__link--active" to="/map">
                    <svg className="navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.938 17.29">
                        <g className="navigation__icon-group" transform="translate(-488.081 -25.282)" stroke="#8c8c8c" strokeWidth="1.109" strokeDashoffset="693.543" paintOrder="fill markers stroke">
                            ...
                            <path className="navigation__pin-path" d="M498.519 29.344c0 1.937-3.508 9.608-3.508 9.608s-3.508-7.67-3.508-9.608a3.508 3.508 0 017.016 0z" fill="#fff" strokeLinejoin="round"/>
            ...
            <li className="navigation__list">
                <NavLink className="navigation__link" activeClassName="navigation__link--active" exact to="/" isActive={() => ['/'].includes(pathname) || pathname.includes('/cities') || pathname.includes('/places')}>
                    <svg className="navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.504 17.315">
                        <g className="navigation__icon-group" fill="none" stroke="#8c8c8c" strokeWidth="1.109" paintOrder="stroke fill markers">
            ...
            <li className="navigation__list">
                <NavLink className="navigation__link" activeClassName="navigation__link--active" to="/profile">
                    <svg className="navigation__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.361 17.344">
                        <g className="navigation__icon-group" fill="none" stroke="#8c8c8c" strokeWidth="1.109">
                            <path d="M10.479 4.341A3.787 3.787 0 016.7 8.128a3.787 3.787 0 01-3.795-3.77A3.787 3.787 0 016.668.554a3.787 3.787 0 013.81 3.755" strokeLinecap="round" paintOrder="stroke fill markers"/>
                            <path d="M2.957 16.79h7.472c1.655 0 3.007-.853 2.07-2.475C9.614 9.333 3.79 9.23.88 14.307c-.95 1.646.319 2.483 2.078 2.483z" strokeLinejoin="round"/>
                        </g>
                    </svg>
                </NavLink>
            </li>
